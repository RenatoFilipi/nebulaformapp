...
import { LayoutGrid, Loader2, Save } from "lucide-vue-next";
...
const handleSaveForm = () => {
  console.log(editorStore.formId);
  console.log(editorStore.formName);
  console.log(editorStore.formElements);
};
</script>
    ...
    <div class="flex flex-col items-center">
      <div class="flex flex-1 w-full flex-col py-40 px-80 gap-12">
        <div class="flex justify-between items-center">
          ...
          <Button @click="handleSaveForm">Save</Button>
        </div>
